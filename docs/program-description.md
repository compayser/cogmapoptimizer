...
2.  Определение симплексов $\sigma^{ibad}_{p}$ вершин - $V_{ibad},\ i = 1,2,\ldots,k$. Симплекс составляют вершины с наибольшим влиянием на $V_{ibad}$. Симплициальный анализ производится на основе работ британского физика Р. Эткина.
