...
- оптимизация ([общего плана-графика стротельства](Example 2 - General plan_rnd.cmj)),
- оптимизация ([частного плана-графика строительного этапа](Example 2 - Particular plan_rnd.cmj)).

Сравнивая [решения, предложенные человеком и ИИ для контрольных примеров](Control example results.zip), можно убедиться в том, что решение ИИ более эффективно.