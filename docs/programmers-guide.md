...
Компонент размещен в репозитории [https://gitlab.actcognitive.org/itmo-sai-code/cogmapoptimizer](https://gitlab.actcognitive.org/itmo-sai-code/cogmapoptimizer).
...
Проверка программы осуществляется с использованием контрольных примеров, находящихся в репозитории в папках примеров из папки [`examples`](../examples).
...
Примеры файлов групп вершин находятся в репозитории в папках примеров из папки [`examples`](../examples).
